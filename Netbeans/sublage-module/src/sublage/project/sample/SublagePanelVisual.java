...
public class SublagePanelVisual extends JPanel implements DocumentListener {

    public static final String PROP_PROJECT_NAME = "projectName";
    private SublageWizardPanel panel;

    public SublagePanelVisual(SublageWizardPanel panel) {
        initComponents();
        this.panel = panel;
    ...
    void read(WizardDescriptor settings) {
        ...
        if (projectName == null) {
            projectName = "SublageApplication";
        }
